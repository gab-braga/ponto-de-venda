...
import com.github.fgabrielbraga.controller.AlterarEstoqueController;
...
public class AlterarEstoque extends Application {
    ...
    public void start(Stage stage) {
        try {
            FXMLLoader file = new FXMLLoader(getClass().getResource("/com/github/fgabrielbraga/view/fxml/alterar_estoque.fxml"));
