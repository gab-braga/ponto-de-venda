...
import com.github.fgabrielbraga.controller.PesquisarProdutoController;
...
public class PesquisarProduto extends Application {
    ...
    public void start(Stage stage) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/github/fgabrielbraga/view/fxml/pesquisar_produto.fxml"));
