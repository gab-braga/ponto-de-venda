...
import com.github.fgabrielbraga.controller.PesquisarClienteController;
...
public class PesquisarCliente extends Application {
    ...
    public void start(Stage stage) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/github/fgabrielbraga/view/fxml/pesquisar_cliente.fxml"));
